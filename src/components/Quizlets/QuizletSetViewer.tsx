...
export default function QuizletSetViewer({
  ...
  // TODO: заменить на реальный user id из AuthProvider/контекста
  const userId = "demo";
  ...
  const matchCards: MatchCard[] = useMemo(
    () =>
      cards.map((c) => ({
        id: c.id,
        term: c.term,
        ...
        <>
          ...
          <div className="qsv-top">
            <div className="qsv-top-left">
              <div className="qsv-search">
                <span className="qsv-search-ico" aria-hidden="true">
                  🔎
                </span>
          ...
          <div className="qsv-head">
            ...
            <div className="qsv-head-row">
              <div>
                <div className="qsv-folder">📁 {setInfo?.slug ?? slug}</div>
                <h1 className="qsv-title">{setInfo?.title ?? "Loading..."}</h1>
              </div>

              <div className="qsv-actions">
                <button className="qsv-pillbtn" type="button">
                  💾 Saved
                </button>
                <button className="qsv-iconbtn" type="button" title="Share" aria-label="Share">
                  ⤴
                </button>
                ...
                <div className="qsv-menubox">
                  ...
                  {menuOpen && (
                    <div className="qsv-menu" role="menu">
                      ...
                      <button className="qsv-menuitem" type="button" role="menuitem" onClick={doExport}>
                        ⬇️ Export
                      </button>

                      <div className="qsv-menudiv" />

                      <button className="qsv-menuitem danger" type="button" role="menuitem" onClick={doDelete}>
                        🗑 Delete
                      </button>
                    </div>
                  )}
            ...
            <div className="qsv-cta">
              <button className="qsv-ctabtn" type="button">
          ...
          <div className="qsv-panels">
            <div className="qsv-panel">
              ...
              <div className="qsv-grid">
                ...
                <button className="qsv-tile" type="button" onClick={() => setShowMatch(true)}>
                  Match
                </button>
                <button className="qsv-tile" type="button">
                  Categories
          ...
          <div className="qsv-view">
            ...
            {!loading && !err && total === 0 && <div className="qsv-muted">No cards in this set.</div>}
              ...
              <>
                ...
                <div className="qsv-bottom">
                  ...
                  <div className="qsv-tools">
                    <button className="qsv-iconbtn" type="button" title="Play" aria-label="Play">
                      ▶
                    </button>
                    <button className="qsv-iconbtn" type="button" title="Shuffle" aria-label="Shuffle">
                      ⟲
                    </button>
                    <button className="qsv-iconbtn" type="button" title="Settings" aria-label="Settings">
                      ⚙
                    </button>
                    <button className="qsv-iconbtn" type="button" title="Fullscreen" aria-label="Fullscreen">
                      ⤢
                    </button>
                  </div>
                </div>
            ...
            <div className="qsv-practice">
              <div className="qsv-practice-head">
                <div className="qsv-practice-left">
                  <div className="qsv-practice-ico" aria-hidden="true">
                    🌀
                  </div>
                  <div className="qsv-practice-title">Learn</div>
                </div>
                <div className="qsv-practice-mid">{learnQs.length ? `${learnI + 1} / ${learnQs.length}` : "—"}</div>
              ...
              <div className="qsv-practice-body">
                <div className="qsv-practice-prompt">{learnQs.length ? learnQs[learnI].prompt : "No questions"}</div>
          ...
          <div className="qsv-section">
            <div className="qsv-section-row">
              ...
              <button className="qsv-linkbtn" type="button">
                Your stats ▾
              </button>
            </div>
